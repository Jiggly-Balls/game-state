...
- Changed `StateManager.change_state` method to take in `clear_overlays` parameter.

## [2.4.1] - 2026-04-29

### Added

- Added `py.typed` file to officially support type checking.

### Fixed

- Fixed various docs & code examples from using outdated API.
